...
fn test_bit_msb_iter() {
    let data = [
        0x20, 0x21, 0xCD, 0x45, 0x20, 0xEC, 0x11, 0xEC, 0x11, 0xEC, 0x11, 0xEC, 0x11, 0xEC, 0x11,
        0xEC, 0x11, 0xEC, 0x11, 0x31, 0xB9, 0x38, 0x57, 0x4C, 0x1D, 0xE2,
    ];
